...
abstract class MessageLyt extends FrameLayout {
...
//    abstract void setOnUserActionClick(OnClickCallback callback);
    ...
    public MessageLyt(Context context, OnClickCallback callback, int type) {
        super(context);
...
//                    }
    ...
    TextView getTextView(String text) {
        ...
        textView.setPadding(8, 18, 8, 8);

        viewsToDisable.add(textView);
        return textView;
    }
}
